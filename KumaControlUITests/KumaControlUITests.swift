...
@MainActor
final class KumaControlUITests: XCTestCase {
    ...
    func testFirstLaunchAutomaticallyShowsOnboarding() {
        ...
        let suiteName = "KumaControlUITests.firstLaunch.\(UUID().uuidString)"
    ...
    func testOnboardingCanAdvanceToServerSetup() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
    ...
    func testProductionFirstLaunchCanAdvanceToServerSetup() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.productionOnboarding.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launch()
    ...
    func testSettingsWindowShowsServerManagementControls() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.settings.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
    ...
    func testSettingsAddServerFlowValidatesAndPersistsConnection() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.settingsAdd.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SHOW_SETTINGS"] = "1"
        app.launch()
    ...
    func testProductionSettingsSceneCanAddSecondServerThroughRealFlow() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.productionSettingsAdd.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SEED_SERVER"] = "1"
    ...
    func testPaywallWindowShowsPurchaseActions() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.paywall.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
    ...
    func testProductionDashboardWindowShowsMonitorRowsThroughRestoredFlow() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.productionDashboard.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SEED_SERVER"] = "1"
    ...
    func testProductionDashboardCanPresentPaywallFromIncidentHistoryButton() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.productionDashboardPaywall.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SEED_SERVER"] = "1"
        app.launchEnvironment["KUMA_UI_TEST_USE_STUB_MONITORING"] = "1"
        app.launchEnvironment["KUMA_UI_TEST_OPEN_RESTORED_DASHBOARD"] = "1"
    ...
    func testDashboardWindowCanSwitchBetweenServers() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.dashboard.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
    ...
    func testDashboardIncidentHistoryCanOpenAndDismiss() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.dashboardHistory.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SHOW_DASHBOARD"] = "1"
        app.launch()
    ...
    func testDashboardSearchCanFilterAndClearResults() {
        let app = XCUIApplication()
        let suiteName = "KumaControlUITests.dashboardSearch.\(UUID().uuidString)"
        app.launchEnvironment["KUMA_SETTINGS_SUITE_NAME"] = suiteName
        app.launchEnvironment["KUMA_UI_TEST_SHOW_DASHBOARD"] = "1"
        app.launch()
