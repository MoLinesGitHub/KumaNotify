...
enum KumaControlAppLaunchBehavior: Equatable {
...
struct KumaControlApp: App {
    ...
    private var onboardingScene: some Scene {
        Window("Welcome to Kuma Control", id: "onboarding") {
    ...
    nonisolated static func launchBehavior(
        hasServerConnection: Bool,
        hasCompletedOnboarding: Bool
    ) -> KumaControlAppLaunchBehavior {
        KumaControlAppLaunchBehavior.determine(
